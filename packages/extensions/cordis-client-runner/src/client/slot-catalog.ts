...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Additive full-column details views selected through `ctx.conversationDetails`.',
    doc: 'Additive full-column details views selected through `ctx.conversationDetails`.\nThe built-in `tool` id stays inside ui-conversation; external entries\nuse unique list ids and receive only the close operation from the host.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'details\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@paperai/ui-workbench DocumentWorkbench',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.hero.agentPreset.mark',
    kind: 'keyed',
    scope: 'root',
    summary: 'Brand mark for one Agent preset, dispatched by preset id.',
    doc: 'Brand mark for one Agent preset, dispatched by preset id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    source: 'packages/client/ui-agent-preset/src/client/brand-slot.ts:18',
  },
  {
    key: 'conversation.hero.agentPreset.status',
    kind: 'single',
    scope: 'root',
    summary: 'Provider-owned discovery and cached readiness information for the selected preset.',
    doc: 'Provider-owned discovery and cached readiness information for the selected preset.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    occupants: [
      ...
      '@paperai/ui-brand PaperAIBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@paperai/ui-workbench StartPage',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.message.userText',
    kind: 'chain',
    scope: 'session',
    summary: 'Product-owned projection of logged user text; declining entries preserve the ordinary bubble.',
    doc: 'Product-owned projection of logged user text; declining entries preserve the ordinary bubble.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      '@paperai/ui-workbench WordSelectionMessage',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.message.userText\', () => ctx.slots.register(\n      { name: \'conversation.message.userText\', select: owner => null },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation DetailsViewHost',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.hero.content\' (@paperai/ui-workbench), so it exists while that entry is mounted',
    occupants: [
      '@paperai/ui-brand PaperAIBrandMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@paperai/ui-brand PaperAIBrandName',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      '@paperai/ui-workbench WorkspaceContent',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.content\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.content\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:70',
  },
  {
