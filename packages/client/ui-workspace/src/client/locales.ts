...
export const zh = {
  ...
  'workspace.add': '添加工作区',
  'workspace.back': '返回工作区列表',
  'workspace.detail.aria': '工作区详情',
  'workspace.sessions.aria': '工作区会话',
  'workspace.sessions.empty': '暂无会话。选择“新会话”即可开始。',
...
export const en = {
  ...
  'workspace.detail.aria': 'Workspace details',
  'workspace.sessions.aria': 'Workspace sessions',
  'workspace.sessions.empty': 'No sessions yet. Choose New Session to start.',
