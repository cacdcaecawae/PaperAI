...
export const zh = {
  ...
  'access.changeFailed': '无法切换访问模式，请重试。',
  ...
  'details.output': '输出',
  'details.running': '运行中…',
  'details.unavailableTitle': '详情视图不可用',
  'details.unavailable': '当前详情插件已卸载或尚未完成加载。',
  'todo.title': '任务',
...
export const en = {
  ...
  'access.changeFailed': 'Couldn’t change the access mode. Try again.',
  ...
  'details.unavailable': 'The selected details plugin is unloaded or has not finished loading.',
  'todo.title': 'To-dos',
