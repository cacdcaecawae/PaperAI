...
export function PaperAIBrandMark({ size, className }: PaperAIBrandMarkProps) {
  return (
    <svg
      ...
      width={size}
    >
      <path className={styles.page} d="M6.75 2.75h6.9l3.6 3.6v14.9H6.75z" />
      <path className={styles.fold} d="M13.5 2.9v3.95h3.95" />
      <path className={styles.rule} d="M9.25 10.25h5.5M9.25 13.25h5.5" />
      <path className={styles.accentRule} d="M9.25 16.25h3.75" />
    </svg>
  )
}
...
/** Official OpenAI mark from Simple Icons 16.26.0 (CC0-1.0). */
export function CodexAgentMark({ size, className }: AgentPresetBrandMarkOwnerProps) {
  return (
    <svg aria-label="Codex" className={className} height={size} role="img" viewBox="0 0 24 24" width={size}>
