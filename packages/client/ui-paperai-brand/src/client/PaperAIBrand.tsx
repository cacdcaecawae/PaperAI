...
/** Decorative OpenAI mark from Simple Icons 16.26.0 (CC0-1.0). */
export function CodexAgentMark({ size, className }: AgentPresetBrandMarkOwnerProps) {
  return (
    <svg aria-hidden="true" className={className} focusable="false" height={size} viewBox="0 0 24 24" width={size}>
...
/** Decorative Claude mark from Simple Icons 16.26.0 (CC0-1.0). */
