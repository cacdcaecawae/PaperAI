...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_agents', 'list_agents', 'lsp', 'paperai_check_gate', 'paperai_commit_document', 'paperai_get_template',
      'paperai_list_documents', 'paperai_list_projects', 'paperai_list_templates', 'paperai_list_versions',
      'paperai_prepare_export', 'paperai_read_document', 'paperai_revert_document', 'pwsh', 'pwsh', 'ralph',
