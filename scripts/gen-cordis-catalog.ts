...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PaperAIAssociateTemplateRequest: 'workspace.md',
  PaperAICommitDocumentRequest: 'workspace.md',
  PaperAIConfirmTemplateRequest: 'workspace.md',
  ...
  PaperAIInstallTemplatePackRequest: 'workspace.md',
  PaperAIListResourcesRequest: 'workspace.md',
  PaperAIListTemplatesRequest: 'workspace.md',
  PaperAIOpenDocumentRequest: 'workspace.md',
  PaperAIReadNodeRequest: 'workspace.md',
  PaperAIResourceList: 'workspace.md',
  PaperAIRestoreDocumentRequest: 'workspace.md',
  PaperAISelectedNodeBuffer: 'workspace.md',
  PaperAITemplateCatalog: 'workspace.md',
  PaperAIUploadTemplateRequest: 'workspace.md',
