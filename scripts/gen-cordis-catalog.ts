...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  paperAiAcpAgents: 'workspace.md',
  paperCommits: 'workspace.md',
  paperDocuments: 'workspace.md',
  paperExports: 'workspace.md',
  paperMcp: 'workspace.md',
  paperProjects: 'workspace.md',
  paperRepository: 'workspace.md',
  paperTemplates: 'workspace.md',
  paperaiWorkbench: 'workspace.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  conversationDetails: 'client-side details selection and layout controller — packages/client/ui-conversation/README.md owns the API',
  ...
  modelsOnboarding: 'client-side product-onboarding policy service — packages/client/ui-settings-models/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AcpProviderDefinition: 'workspace.md',
  AddLibraryFormatInput: 'workspace.md',
  AssociateTemplateInput: 'workspace.md',
  BuildCandidateDocumentIndexRequest: 'workspace.md',
  CapabilityHealth: 'workspace.md',
  ChangeConflict: 'workspace.md',
  CheckTemplateCandidateInput: 'workspace.md',
  CheckTemplateInput: 'workspace.md',
  CreatePaperProjectInput: 'workspace.md',
  CreatePaperProjectResult: 'workspace.md',
  DocumentCommit: 'workspace.md',
  DocumentCommitHistory: 'workspace.md',
  DocumentCommitId: 'workspace.md',
  DocumentCommitIdType: 'workspace.md',
  DocumentCommitPublication: 'workspace.md',
  DocumentId: 'workspace.md',
  DocumentNode: 'workspace.md',
  DocumentNodeId: 'workspace.md',
  ...
  ExportDocumentResult: 'workspace.md',
  GateReport: 'workspace.md',
  ImportDocumentRequest: 'workspace.md',
  ImportDocumentResult: 'workspace.md',
  InstallTemplatePackInput: 'workspace.md',
  PaperAIAddTemplateFormatRequest: 'workspace.md',
  PaperAIApplyTemplateRequest: 'workspace.md',
  PaperAICommitDocumentRequest: 'workspace.md',
  PaperAICreateFromTemplateRequest: 'workspace.md',
  PaperAICreateTemplateSetRequest: 'workspace.md',
  PaperAIDeleteTemplateSetRequest: 'workspace.md',
  PaperAIDetachTemplateRequest: 'workspace.md',
  PaperAIDiffVersionRequest: 'workspace.md',
  PaperAIDocumentChangedEvent: 'workspace.md',
  PaperAIDocumentCommitResult: 'workspace.md',
  PaperAIDocumentOpenResult: 'workspace.md',
  PaperAIDocumentTypeSuggestion: 'workspace.md',
  PaperAIExportDocumentRequest: 'workspace.md',
  PaperAIExportDocumentResult: 'workspace.md',
  PaperAIImportDocumentRequest: 'workspace.md',
  PaperAIImportDocumentResult: 'workspace.md',
  PaperAIOpenDocumentRequest: 'workspace.md',
  PaperAIOverviewRequest: 'workspace.md',
  PaperAIProjectOverview: 'workspace.md',
  AcpDiagnostic: 'workspace.md',
  AcpCatalogEntry: 'workspace.md',
  AcpSessionDetails: 'workspace.md',
  AcpManagementRequest: 'workspace.md',
  AcpManagementResult: 'workspace.md',
  ProjectIntegrityReport: 'workspace.md',
  WorkingRecoveryPlan: 'workspace.md',
  PaperAIAgentDiagnostic: 'workspace.md',
  PaperAIProbeAgentRequest: 'workspace.md',
  PaperAIProjectIntegrityReport: 'workspace.md',
  PaperAIRecoverWorkingRequest: 'workspace.md',
  PaperAICaptureExternalRequest: 'workspace.md',
  PaperAIReadNodeRequest: 'workspace.md',
  PaperAIRemoveTemplateFormatRequest: 'workspace.md',
  PaperAIRestoreDocumentRequest: 'workspace.md',
  PaperAISelectedNodeBuffer: 'workspace.md',
  PaperAISetProjectTemplateRequest: 'workspace.md',
  PaperAISuggestDocumentTypeRequest: 'workspace.md',
  PaperAITemplateLibrary: 'workspace.md',
  PaperAIValidateDocumentRequest: 'workspace.md',
  PaperAIValidateResult: 'workspace.md',
  PaperAIVersionDiff: 'workspace.md',
  PaperDocumentSnapshot: 'workspace.md',
  PaperMcpAccessScope: 'workspace.md',
  PaperMcpAgentIdentity: 'workspace.md',
  PaperMcpDescriptorLease: 'workspace.md',
  PaperMcpExportAdapter: 'workspace.md',
  PaperMcpExportResult: 'workspace.md',
  ProjectId: 'workspace.md',
  ProjectRecord: 'workspace.md',
  CaptureExternalRequest: 'workspace.md',
  RevertDocumentCommitRequest: 'workspace.md',
  SubmitDocumentCommitRequest: 'workspace.md',
  TemplateContract: 'workspace.md',
  TemplateContractId: 'workspace.md',
  TemplateLibraryPack: 'workspace.md',
  TemplatePackManifest: 'workspace.md',
  TemplatePackSummary: 'workspace.md',
  UploadTemplateInput: 'workspace.md',
