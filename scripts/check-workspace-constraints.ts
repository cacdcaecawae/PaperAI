...
/** Source home for PaperAI-owned product-layer packages in this fork. */
const paperAiRepositoryUrl = 'git+https://github.com/cacdcaecawae/PaperAI.git'
...
function checkWorkspace({ dir, manifest }: WorkspaceManifest): string[] {
  ...
  if (isPublicLandlockPackage) {
    ...
    const expectedRepositoryUrl = manifest.name?.startsWith('@paperai/') === true
      ? paperAiRepositoryUrl
