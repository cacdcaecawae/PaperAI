...
来源：[`packages/interaction/permission-presets/src/index.ts:185`](../packages/interaction/permission-presets/src/index.ts)
...
来源：[`packages/paperai/workbench-service/src/index.ts:279`](../packages/paperai/workbench-service/src/index.ts)
